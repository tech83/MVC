            ...
            else
            {
                ...
                if (ids.PurchaseId > 0)
                {
                    foreach (var item in obj.purachasedetail)
                    {
                        ...
                        grandtotal += Convert.ToInt32(netamount);
                        ...
                        objDebit2.HeadCode = Convert.ToInt32(objtbtaxconfig.TAX1ACCOUNT); //NEDD TO DISCUSS
               ...
               // objTBSALEHEADER.BillDate = obj.BillDate;
                ...
                if (ids.SaleId > 0)
                {
                    foreach (var item in obj.saledetail)
                    {
                        ...
                        objCredit2.HeadCode = Convert.ToInt32(objtbtaxconfig.TAX1ACCOUNT);
